  ...
  class TermsControllerTest < ActionController::TestCase
    ...
    test "should create term" do
      assert_difference('Term.count') do
        post :create, term: { company_id: @term.company_id, quoteterms: @term.quoteterms, terms: @term.terms }
      end
    ...
    test "should update term" do
      patch :update, id: @term, term: { company_id: @term.company_id, quoteterms: @term.quoteterms, terms: @term.terms }
      assert_redirected_to term_path(assigns(:term))
    end
