  ...
  class DonorsControllerTest < ActionController::TestCase
    ...
    test "should create donor" do
      assert_difference('Donor.count') do
        post :create, donor: { first_name: @donor.first_name, house: @donor.house, postcode: @donor.postcode, surname: @donor.surname, title: @donor.title }
      end
    ...
    test "should update donor" do
      patch :update, id: @donor, donor: { first_name: @donor.first_name, house: @donor.house, postcode: @donor.postcode, surname: @donor.surname, title: @donor.title }
      assert_redirected_to donor_path(assigns(:donor))
    end
