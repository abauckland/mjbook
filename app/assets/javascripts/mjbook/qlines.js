...
// update category
	...
	var line_id = $(this).attr('id');	
		$(this).editable('http://localhost:3000/mjbook/qlines/'+line_id+'/update_cat', {
...
// update quantity	
	...
	var line_id = $(this).attr('id');	
		$(this).editable('http://localhost:3000/mjbook/qlines/'+line_id+'/update_quantity', {
			id: line_id, width: ($(this).width() +10)+'px',
			type: 'text',
			ajaxoptions: {dataType: 'script'},
			onblur: 'submit',
...
// update unit	
	...
	var line_id = $(this).attr('id');
		$(this).editable('http://localhost:3000/mjbook/qlines/'+line_id+'/update_unit', {
			id: line_id, width: ($(this).width() +10)+'px',
...
// update vat rate	
	...
	var line_id = $(this).attr('id');
		$(this).editable('http://localhost:3000/mjbook/qlines/'+line_id+'/update_vat_rate', {
			id: line_id, width: ($(this).width() +10)+'px',
...
// update vat due	
	...
	var line_id = $(this).attr('id');
		$(this).editable('http://localhost:3000/mjbook/qlines/'+line_id+'/update_vat_due', {
			id: line_id, width: ($(this).width() +10)+'px',
			type: 'text',
			onblur: 'submit',
			method: 'PUT',
...
// update text	
	...
	var line_id = $(this).attr('id');
		$(this).editable('http://localhost:3000/mjbook/qlines/'+line_id+'/update_text', {
			id: line_id, width: ($(this).width() +10)+'px',
			type: 'autogrow',
			onblur: 'submit',
			method: 'PUT',
